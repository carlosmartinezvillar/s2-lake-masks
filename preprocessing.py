...
def print_checkerboard(safe_dir,windows,quant_val,offset_vals):
	#yellow #FFFF00
...
#TODO
def save_tci_full_windowed(dst_path,bands,borders,windows]):
...
#TODO
def save_tci_full(path, bands, quant_val, offsets):
	"""
...
if __name__ == '__main__':
	...
	label_path = DATA_DIR + '/'.join(["dynamicworld",gee_id]) + '.tif'
